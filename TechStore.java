       ...
       System.out.println("soyez les bienvenus!!");
        ...
        int catego = scanner.nextInt();
         switch(catego){
          ...
          AppareilInfo.SystemExploite systeme;
          switch(sys){
          ...
          stock.AjouterArticle(nom,prix,res,ram,disqueDur,process,carteGraphique,systeme,alimentation,quantArt);
        }
          ...
          long q= scanner.nextLong();
				...
				case 1:
					...
					Stock.incrementerQuantiteArticle(ref,np); // on utlise la fonction d'aumgmentation de class stock
					break;
				case 2:
          ...
          break;
				...
				case 3:
					...
					Stock.SupprimerArticle(refs);// la fonction de suppression d'article de la class stock
					break;
        case 4: 
         Stock.toString(); //importer la methode toString de la class stock pour consulter le stock
				case 5:
					System.out.println("QUITTER !");
                        ...
                        System.out.println(" bonjour chér(e) client(e)");
                 }
                 else {
